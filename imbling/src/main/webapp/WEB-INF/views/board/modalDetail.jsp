...
<div class="container">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <form method="post" id="reviewDetail" name="reviewDetail" action="reviewDetail">
                ...
                <div style="float: right;">
                    <a href="/board/notice"class="btn btn-success">목록보기</a>
                </div>
                <h5>1:1 문의 상세보기</h5>
        ...
        <div class="card-body">
            <div class="col-sm-6" style="float: right;">
                <div class="form-group">
                    <label>별점</label>
                    <input type="text" class="form-control" id="" value="${board.userId}" name="orderNo" readonly>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
        ...
        <form id="faqCommentForm" action="faqCommentForm" method="post">
            <input type="hidden" name="boardNo" value="${ board.boardNo }" />
            <input type="hidden" name="pageNo" value="${ pageNo }" />
            <div class="col-sm-9" style="float: right;">
                <div class="form-group">
                    <textarea id="commentContent" name="commentContent" class="form-control" rows="3" placeholder="답변하기"></textarea>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    <input class="form-control" value="${loginuser.userId}" name="writer" readonly >
                    <a id="faqCommentBtn" href="javascript:" class="btn btn-primary" style="width: 100%; margin-top: 10px"> 답변하기 </a>
                </div>
            </div>
        </form>
    </div>
...
<div class="container">
    <div class="table-responsive">
        <table class="table table-bordered" id="commentFaqList" width="100%" cellspacing="0">
...
<script type="text/javascript">
    ...
    $(function (){
        $('#commentFaqList').load("faqCommentList?boardNo=${board.boardNo}");
        $('#faqCommentBtn').on('click',function (event){
            const formData = $('#faqCommentForm').serialize();
            $.ajax({
                "url":"/board/faqCommentForm",
                "method":"post",
                "data":formData,
