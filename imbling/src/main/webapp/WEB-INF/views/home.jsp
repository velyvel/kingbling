                ...
                <div class="row product__filter">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                                <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="/resources/dist/img/product/product-1.jpg">
                                                <span class="label">New</span>
                                                <ul class="product__hover">
                                                        <li><a href="#"><img src="/resources/dist/img/icon/heart.png" alt=""></a></li>
                                                        <li><a href="#"><img src="/resources/dist/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                                <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="/resources/dist/img/product/product-5.jpg">
                                                <ul class="product__hover">
                                                        <li><a href="#"><img src="/resources/dist/img/icon/heart.png" alt=""></a></li>
                                                        <li><a href="#"><img src="/resources/dist/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                                        <li><a href="#"><img src="/resources/dist/img/icon/search.png" alt=""></a></li>
